...
import org.nexc.core.components.animations.SuccessLottie
import org.nexc.core.theme.NexcTheme

@Composable
fun SuccessScreen(
    route: Route.SuccessScreen,
    navController: NavHostController
) {
    val message = route.message
    val workoutJson = route.workoutJson
    val clipboardManager = LocalClipboardManager.current
    NexcScaffold { innerPadding ->
        BoxWithConstraints(
...
private fun SuccessScreenPreview() {
    NexcTheme(dynamicColor = false, themeMode = ThemeMode.DARK) {
        SuccessScreen(Route.SuccessScreen(SuccessMessage.WORKOUT_SAVED), rememberNavController())
    }
}