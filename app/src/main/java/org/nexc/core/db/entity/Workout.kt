 ...
 * @property title The title of the workout visible to the user. The user can modify it in [org.nexc.features.workout.WorkoutScreen]
 * and [org.nexc.features.editWorkout.EditWorkoutScreen]
 * @property notes A user note about the routine or workout. The user can modify it in [org.nexc.features.workout.WorkoutScreen]
 *  * and [org.nexc.features.editWorkout.EditWorkoutScreen]
 * @property state It indicates whether the workout is a workout, routine, archived or in the library of workouts.
 * When it is set as `ROUTINE`, it will be displayed as a playable routine in the [org.nexc.features.home.HomeScreen]
 * and the info in [org.nexc.features.infoWorkout.InfoWorkoutScreen] will be shown differently.
 ...
 * [org.nexc.core.services.WorkoutService]'s stopwatch during a workout session.
 ...
 * finished in the [org.nexc.features.workout.WorkoutScreen].
 */
