...
interface WorkoutDao {
    /**
     * Returns a flow that emits a stream of [org.nexc.core.db.entity.Workout]s filtered by [state]
     */
    ...
    /**
     * Returns a flow list [org.nexc.core.db.relations.WorkoutWithExercisesAndSets]s filtered by [state].
    ...
    /**
     * Retrieves the list of [org.nexc.core.db.relations.ExerciseWithSets] associated with a specific workout.
    ...
    /**
     * It provides all [WorkoutWithExercisesAndSets] having the passed [org.nexc.core.db.entity.ExerciseDC] in [Exercise] and
     * the passed [state]
     */
    @Transaction
    @Query(
