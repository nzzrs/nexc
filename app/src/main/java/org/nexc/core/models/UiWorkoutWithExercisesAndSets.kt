...
/**
 * The [org.nexc.core.db.relations.WorkoutWithExercisesAndSets] model used only by the ui. The difference is the use
 * of [ImmutableList] instead of [List] in order to ensure the [Immutable] annotation and improve
 * composition performance.
 *
 * @see [org.nexc.core.db.relations.WorkoutWithExercisesAndSets]
 */
@Immutable
